...
#include <map>
#include <set>
#include "ProCamSolver/numerical.h"
#include "ProCamSolver/RadialViewProjectionMatrix.h"
#include "ProCamSolver/Correspondence.h"
...
namespace ProCamSolver {
	...
	public:
	  ...
	  double	operator()(nrlib::VecDoub_I &);
	  void		df(nrlib::VecDoub_I &, nrlib::VecDoub_O &);
	...
	protected:
	  ...
	  void		init_views();
	  double	solve();
	  double	correspondence_error(Correspondence &, Matrix<double> &);
	  void		params_to_vpmatrices(nrlib::VecDoub_I &);
	  void		vpmatrices_to_params(nrlib::VecDoub &);
	...
	protected:
	  std::vector<Correspondence> 	C;   	   // the pixel correspondences to fit
